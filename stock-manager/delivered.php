                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      , u.lastname AS Lname
                      , (SELECT CONCAT(CONCAT(firstname, ' '), lastname) FROM users WHERE users.id = d.userId) as names
                      , CASE d.status 
                        WHEN 0 THEN 'Pending'
                        ELSE 'Delivered'
                        END dStatus
                    , (SELECT contact_info FROM users WHERE users.id = d.userId) as contacts
