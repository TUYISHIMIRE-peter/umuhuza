      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, products.price as price, sales.quantity as quantity FROM sales INNER JOIN products ON products.id=sales.prod_id");
                $stmt->execute();
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT s.quantity as quantity, p.price as price FROM sales s LEFT JOIN products p ON p.id=s.prod_id WHERE sales_date=:sales_date");
...
<?php
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    try{
      $stmt = $conn->prepare("SELECT *, s.quantity as quantity, p.price as price FROM sales s LEFT JOIN products p ON p.id=s.prod_id WHERE MONTH(sales_date)=:month AND YEAR(sales_date)=:year");
