        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_edit.php">
                ...
                <div class="form-group">
                  <label for="pquantity" class="col-sm-1 control-label">Quantity</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="edit_quantity" name="quantity" required>
                  </div>
                  <label for="edit_store" class="col-sm-1 control-label">Store Location</label>
                  
                  <div class="col-sm-5">
                    <select class="form-control" id="edit_status" name="status">
                      <option value="new" selected id="statusselected">New</option>
                      <option value="sale" selected id="statusselected2">Sale</option>
                    </select>
                  </div>
                </div>

                <div class="form-group">
                  <label for="edit_type" class="col-sm-1 control-label">Type</label>
                  ...
                  <div class="col-sm-5">
                    <select class="form-control" id="edit_store" name="store">
                      <option selected id="storeselected"></option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
