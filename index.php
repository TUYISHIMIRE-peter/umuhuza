        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> UMUHUZA</strong></h1>
                            <p class="m-b-40">You will experience UMUHUZA E-agribusiness in real time <br> it is simple to access and we offer accessing guide . please click the following button.</p>
                            <p><a class="btn hvr-hover" href="shopguide.php">Shopping Guide</a> <a class="btn hvr-hover" href="shop.php">Shop Now</a></p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="#">Vegetables & Grains</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="#">Eggs/ Dairy/ Meats & Fishes</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Bellow we have popular products from fruits and vegetables categories.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                ...
                                <a class="cart" href="shop.php">Visit Shop</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h4>Carrots</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>These Products available according to the season.</p>
                    </div>
                </div>
            </div>
            <div class="row">
