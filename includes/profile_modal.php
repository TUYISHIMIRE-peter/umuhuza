...
<!-- Assign Transaction to deliverer carrier -->
<div class="modal fade" id="delivering">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Choose Deriverer </b></h4>
            </div>
          <form action="delivery.php" method="post">
            <div class="modal-body">
              <span class="pull-right">Transaction#: <span id="transactionId"></span></span>
              <select name="deliverer" id="deliverer" class="form-control" required="required">
                <option value=""> Select deliverer </option>
              </select>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" name="assign" class="btn btn-success btn-flat pull-right assign" data-dismiss="modal"><i class="fa fa-check"></i> Submit</button>
            </div>
          </form>
        </div>
    </div>
