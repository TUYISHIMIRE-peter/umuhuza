...
<body>
                ...
                <li class="cart-box">
                    ...
                    <ul class="cart-list">
                        ...
                        <!-- <li class="total">
                            ...
                            <span class="float-right"><strong>Total</strong>: RWF180.00</span>
                        </li> -->
                    </ul>
                </li>
            </div>
            ...
            <div class='row my-5'>
                ...
                <div class='col-lg-4 col-sm-12'>
                    <div class='order-box' id='orderSummary'>
                        <!-- codes of order summary from orderSummaryDetails.php  -->
                    </div>
                </div>
    ...
    <script src="js/custom.js"></script>
				...
				$(document).ready(function(){
					 ...
					 $('#tableTotal').on('change', function(){
						 $('#subtotalfield').val($(this).val());
					 });
					 });
				</script> -->
</body>
